...
module Buff : BuffMod with type grid = Grid.grid = struct 
    ...
    let update buff = 
        buff.line := List.append buff.left buff.right 
    ...
    let ch_buff grid buff row = 
        update buff; Grid.optimize buff.line; 
